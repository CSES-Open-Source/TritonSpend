...
export const DonutCard: React.FC<{ title: string; centerMetric: string }> = ({
  title,
  centerMetric,
}) => {
  return (
    <Card padding="$5" backgroundColor="$surfaceTintGreen">
      <AppText variant="subtitle" marginBottom="$5" color="$textMuted">
        {title}
      </AppText>
      ...
      <YStack alignItems="center" justifyContent="center">
        ...
        >
          <YStack alignItems="center" justifyContent="center">
            <AppText fontWeight="bold" fontSize="$7">
              {centerMetric}
            </AppText>
