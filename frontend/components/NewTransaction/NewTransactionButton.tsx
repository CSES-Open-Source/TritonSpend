import { View, StyleSheet, Text, Animated, Pressable, TextInput } from "react-native";
...
export default function NewTransactionButton() {
  ...
  function toggle(){
    ...
    return(
      ...
      {inputVisible? (
              <Animated.View style={[styles.inputContainer,{transform: [{translateY:inputShow}], opacity:animatedOpacity} ]}>
                <TextInput
